  ...
  return (
    <HStack className="h-16 items-center justify-between border-b border-slate-200 bg-white px-6 dark:border-slate-700/60 dark:bg-slate-900">
      ...
      <HStack className="items-center gap-2">
        {showSearch ? (
          <HStack className="h-9 w-64 items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 dark:border-slate-700 dark:bg-slate-800">
